...
function StudentCard({ stats }: { stats: StudentStats }) {
  ...
  return (
    <article className="rounded-2xl border border-[#e0dfeb] bg-white p-5 shadow-[0_10px_30px_rgba(56,50,110,0.05)]">
      ...
      <dl className="mt-4 grid grid-cols-2 gap-3">
        <div className="rounded-xl bg-[#f7f7fb] px-3 py-2.5">
          ...
          <dd className="mt-1 font-heading text-xl font-bold text-[#5755d8]">
            {stats.sessionCount}
          </dd>
        </div>
        <div className="rounded-xl bg-[#f7f7fb] px-3 py-2.5">
          ...
          <dd className="mt-1 font-heading text-xl font-bold text-[#8127cf]">
      ...
      <Link
        ...
        className="mt-4 inline-flex rounded-xl bg-[#5755d8] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#4846c5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)] focus-visible:ring-offset-2"
      >
