...
- "ADVANCE" node_id (or omit node_id): time to move to a new, not-yet-covered concept — also use this to steer an off-topic/derailing utterance back toward the topic. Do not invent node matches or quotes from pure off-topic / small-talk / inappropriate text; leave verdicts empty and recommend ADVANCE (or WRAP_UP only via the rules below).
