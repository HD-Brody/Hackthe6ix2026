    ...
    <div className="flex min-h-screen flex-col bg-[var(--page-background)]">
      ...
      <main className="home-background flex-1">
        <section className="mx-auto flex w-full max-w-7xl flex-col items-center px-5 pb-28 pt-14 sm:px-8 sm:pb-36 sm:pt-20 lg:px-10">
          <p className="eyebrow">The Feynman technique, finally in software</p>

          <h1 className="font-display mt-4 max-w-3xl text-center text-[2.4rem] font-semibold leading-[1.12] tracking-[-0.02em] text-[var(--text-primary)] sm:text-5xl lg:text-[3.6rem]">
            <span className="chalk-underline">Teach it</span> to learn it.
          </h1>

          <p className="mt-5 max-w-xl text-center text-base leading-7 text-[var(--text-secondary)] sm:text-lg">
