          ...
          <section className="flex items-center justify-center p-6 sm:p-8 lg:px-10 lg:py-8" aria-labelledby="signup-title">
            <div className="w-full max-w-md">
              ...
              <div className="mt-5 flex justify-center">
                <a href="/auth/login?screen_hint=signup&connection=google-oauth2" aria-label="Sign up with Google" className="flex h-12 w-full items-center justify-center rounded-lg border border-[#c7c4d7] bg-white transition hover:bg-[#f7f9fb] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)] focus-visible:ring-offset-2">
